...
public class LayoutFileParserForTextExtraction extends AbstractResourceParser {
	...
	//callbackName -> List<FlowTriggerEventObject>
	private final Map<String, FlowTriggerEventObject> callbackMap = new HashMap<String, FlowTriggerEventObject>();
	...
	public Map<String, FlowTriggerEventObject> getCallbackMap() {
		return callbackMap;
	}
